...
<h:panelGrid columns="2" border="1" styleClass="formdiv" bgcolor="red">
  ...
  <h:inputText id="rohit" value="#{manageBeanTeamCity.jobName}"></h:inputText>
  <h:outputLabel>enter job url</h:outputLabel>
  <h:inputText id="rohit1" value="#{manageBeanTeamCity.joburl}"></h:inputText>
  <h:commandButton value="submit" action="#{manageBeanTeamCity.callService}" ></h:commandButton>
